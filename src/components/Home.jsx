  ...
  return (
    <>
      <div className="w-full min-h-full p-0 md:pb-[100px] pt-4 md:pt-0 flex justify-around items-center flex-col md:flex-row">
        <div className="font-Poppins ml-0 md:ml-8 mt-12 md:mt-0" data-aos="fade-right">
        ...
        <div className="w-full md:w-[500px] h-[500px] flex items-start md:items-center md:mx-0 " data-aos="fade-left" >
